...
image_dir = r'Images'
model_dir = r'C:\Users\AVITA\Desktop\Neural_Algorithm_Artistic_Style-master\vgg_conv_weights.pth'
...
vgg.load_state_dict(torch.load(model_dir))            
...
img_names = [r'\style_vangogh_tree.jpg', r'\hrithik.jpg']
...
j = Image.fromarray(out_img, mode='RGB')
j.save(r'C:\Users\AVITA\Desktop\Neural_Algorithm_Artistic_Style-master\hhh.jpg')
